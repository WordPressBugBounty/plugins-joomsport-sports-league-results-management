...
<div class="table-responsive">
    ...
    if (count($rows->lists['team_events'])) {
        ...
        <div class="jsMatchStatMatchDiv">
            <div class="jsMatchStatHeader jscenter">
                <h3>
                    <?php echo esc_html__('Match statistic','joomsport-sports-league-results-management'); ?>
                </h3>
            </div>
    ...
    if (jsHelper::getADF($rows->lists['ef'])) {
        ...
        <div class="jsAdditionStatMatchDiv">
            <div class="jsMatchStatHeader jscenter">
                <h3>
                    <?php echo esc_html__('Additional information','joomsport-sports-league-results-management'); ?>
                </h3>
            </div>
