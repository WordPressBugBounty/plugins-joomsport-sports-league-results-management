...
require_once JOOMSPORT_PATH_INCLUDES . 'joomsport-terms-meta.php';
require_once JOOMSPORT_PATH_INCLUDES . 'joomsport-settings.php';
require_once JOOMSPORT_PATH_INCLUDES . 'joomsport-permalink.php';
require_once JOOMSPORT_PATH_INCLUDES . 'joomsport-upgrade.php';
...
require_once JOOMSPORT_PATH_HELPERS . 'js-helper-matches-db.php';
require_once JOOMSPORT_PATH_HELPERS . 'js-helper-events.php';
