...
* Integration with [Mobile App](https://app.joomsport.com "Sport mobile application for sport teams and leagues") service
* and a lot of others...
...
* [Real Soccer](https://themeforest.net/item/real-soccer-sport-clubs-responsive-wp-theme/8888574?ref=beardev "Bestselling WordPress sport theme") by GoodLayers
...
2. Matches schedule (football, soccer sport)
3. Match view. Main (ice hockey)
4. Match view. Box score (ice hockey) 
5. Team view. Main (soccer)
6. Team view. Roster (football, soccer)
7. Team view. Player Stats (football, soccer)
8. Team view. Overview (soccer)
9. Season players list (soccer)
10. Knockout tournament, brackets (pro version, soccer)
11. Single Player view (chess)
12. Team Player view. Statistic (pro version, football)
13. Venue page (American football)
14. Widgets (Soccer, American football)
...
= 5.5.8=
[version overview](https://beardev.com/blog/joomsport-for-wordpress-ver-5-5-performance-release "JoomSport performance release") 
...
= 5.2.2 =
[version overview](https://beardev.com/blog/joomsport-5-2-for-wordpress-live-scores-team-moderation "JoomSport live scores, team moderating") 
...
= 5.1.1 =
[version overview](https://beardev.com/blog/joomsport-for-wordpress-new-version-released "JoomSport automatic game stages") 
...
= 5.0 =
[version overview](https://beardev.com/blog/future-matches-analytics-added "JoomSport head to head analytics") 
...
= 3.2 =
[version overview](https://beardev.com/blog/joomsport-3-2-for-wordpress-released-performance-improved "JoomSport WordPress sports plugin update") 
...
= 3.1 =
[version overview](https://beardev.com/blog/joomsport-3-1-no-features-pure-beauty-is-delivered "JoomSport WordPress sports plugin update") 
...
= 3.0 - 3.0.1 =
[version overview](https://beardev.com/blog/joomsport-sport-plugin-ver-3-0-for-wordpress-persons-and-other-core-improvements  "JoomSport WordPress sports plugin update") 
...
= 2.1 =
[version overview](https://beardev.com/blog/joomsport-for-wordpress-2-1-roster-csv-import-and-more "JoomSport WordPress sports plugin update") 
...
= 2.0 - 2.0.2 =
[version overview](https://beardev.com/blog/revolutionary-update-joomsport-2-0-for-wordpress-released "JoomSport WordPress sports plugin update") 
...
* [Match generator](https://beardev.com/blog/joomsport-match-generator-add-on-saves-your-forces-for-bigger-challenges "WordPress league schedule generator") (Pro edition)
...
= 1.3.0 - 1.3.1 =
[version overview](https://beardev.com/blog/joomsport-for-wordpress-1-3-x-release-features-overview "JoomSport WordPress sports plugin - Moderation added") 
...
= 1.2.1 - 1.2.3 =
[version overview](https://beardev.com/blog/joomsport-for-wordpress-1-2-x-release-features-overview "JoomSport WordPress sports plugin - new release") 
