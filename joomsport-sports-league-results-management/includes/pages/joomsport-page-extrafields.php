...
class JoomSportExtraFields_List_Table extends WP_List_Table {
    ...
    function column_name( $item ) {
        ...
        $actions = array(
          'delete' => sprintf( '<a href="?page=%s&action=%s&extrafield=%s&_wpnonce=%s">Delete</a>', (isset($_REQUEST['page'])?( sanitize_text_field(wp_unslash($_REQUEST['page'])) ):''), 'delete', absint( $item['id'] ), $delete_nonce )
        );
